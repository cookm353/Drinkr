...
function getDescription() {
    return __awaiter(this, void 0, void 0, function () {
        var pageURL, ingredientIndex, ingredientName, resp, description;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    pageURL = window.location.href;
                    ingredientIndex = pageURL.search('ts/') + 3;
                    ingredientName = pageURL.slice(ingredientIndex);
                    return [4 /*yield*/, axios.get("https://www.thecocktaildb.com/api/json/v1/1/search.php?i=".concat(ingredientName))];
                case 1:
                    resp = _a.sent();
                    description = resp['data']['ingredients'][0]['strDescription'];
